...
export default async function BlogPage(props: BlogPageProps) {
  ...
  return (
    <>
      ...
      <RenderBuilderLiveDataPreview
        templateModelName={builderBlogTemplateModelName}
        templateModelData={blogTemplate}
        dataModelName={builderBlogModelName}
        dataModelData={blogData}
      />
    </>
  );
}
