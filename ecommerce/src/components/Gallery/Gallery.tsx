...
function CollectionSection() {
  return (
    <div className="px-8 py-8">
      ...
      <Example label="Carousel: with dots" hint="variant: carousel, showDots: true" fullWidth>
        <Collection collection="all" variant="carousel" showDots />
      </Example>
      <Example label="Carousel: without dots" hint="variant: carousel, showDots: false" fullWidth>
        <Collection collection="all" variant="carousel" showDots={false} />
      </Example>
    </div>
  );
}
...
const navSections = [
  ...
  },
  {
    title: "Commerce",
    items: [
      { name: "Collection", examples: 3, group: "Commerce", description: "Horizontally scrolling product collection sourced from Builder product data and filtered by collection. Includes a carousel variant with side arrows and optional dot indicators.", inputs: "collection, variant, showDots", component: CollectionSection },
