  ...
  return (
    ...
    >
      {options?.map((option, index) => (
        <div
          key={index}
          className={`shrink-0 rounded-lg flex overflow-hidden justify-center border-solid h-[119px] w-[136px] cursor-pointer ${
            selectedImage?.image == option.image
        ...
        >
          ...
          >
            <img src={option.image} alt={option.altText} />
          </Label>
        </div>
      ))}
    </RadioGroup>
...
const ProductDetails: FC<ProductDetailsProps> = ({ product }) => {
  ...
  const [selectedSize, setSelectedSize] = useState(
    product?.data?.sizes?.[0]?.label || null,
  );
  ...
  return (
    <BuilderContent model="product-data" content={product}>
      {(productData) => {
        ...
        const productName = getLocalizedText(productData?.productName);
        const productDescription = DOMPurify.sanitize(getLocalizedText(productData?.description));
              ...
              <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                ...
                <div className="flex flex-col ml-5 w-[42%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow px-5 mt-2 md:mt-10 max-md:max-w-full">
                    ...
                    <div
                      className="mt-14 text-lg text-black max-md:mt-10 max-md:max-w-full"
