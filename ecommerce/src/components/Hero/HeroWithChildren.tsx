...
const HeroWithChildren: React.FC<HeroWithChildrenProps> = (props:any) => {
  return (
    <div className={`flex flex-col justify-between items-center p-20 bg-background text-foreground max-md:px-5 ${props.makeFullBleed ? 'w-screen  ml-[calc(50%-50vw)] max-h-full' : ''}`}>
